...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Player adarsh = new Player("AJ",56,89);
        System.out.println(adarsh.toString());
        saveObject(adarsh);
        adarsh.setHitPoints(10);
        System.out.println(adarsh);
        adarsh.setWeapon("AK47");
        saveObject(adarsh);
        loadObject(adarsh);
        System.out.println(adarsh);
    ...
    public static void saveObject(SInterface object)
    {
        for(int i=0 ; i <object.write().size();i++)
        {
            System.out.println("Saving "+object.write().get(i)+ " to storage devices");
        }
    }

    public static void loadObject(SInterface object)
    {
